...
const advantages: AdvantageItem[] = [
  {
    ...
    description:
      "Проверенный опыт в сфере складского оборудования и логистических решений.",
  },
  {
    icon: (
      <svg
    ...
    title: "Гибкая оплата",
    description:
      "Удобный способ оплаты – рассрочка, лизинг, trade-in старой техники.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Проектирование и подбор готовых инженерных решений под ваш склад.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Монтаж и настройка оборудования силами аттестованных инженеров.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Плановое и внеплановое ТО, диагностика, срочный выезд при поломке.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Актуальный ассортимент по конкурентным ценам без посредников.",
  },
];
        ...
        {advantages.map((item, index) => (
          ...
          >
            ...
            <div className="flex gap-[16px] flex-col">
              <h3
                className="text-[1.25rem] max-sm:text-[1.2rem] font-bold text-balance max-sm:wrap-anywhere"
                lang="ru"
              >
                {item.title}
              </h3>
